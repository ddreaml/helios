...
public class ZooKeeperMasterModel implements MasterModel {
  ...
  public HostStatus getHostStatus(final String host) {
    ...
    final List<String> labels = getLabels(client, host);
  ...
  private List<String> getLabels(final ZooKeeperClient client, final String host) {
    return tryGetEntity(client, Paths.statusHostLabels(host), STRING_LIST_TYPE, "labels");
  }
